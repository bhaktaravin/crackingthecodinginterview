...
public class Chapter1Problems {
    ...
    // Problem 1.1: Is Unique (Optimized with Bit Vector)
    public static String runIsUnique(String input) {
        if (input.isEmpty()) input = "abc aaa";
    ...
    private static boolean hasUniqueCharactersOptimized(String str, StringBuilder output) {
        int checker = 0;
    ...
    public static String runCheckPermutation(String input, boolean useUnicode) {
        if (input.isEmpty()) input = "abcdefg hello olleh apple padle kite";
    ...
    // Problem 1.3: URLify
    public static String runURLify(String input) {
        if (input.isEmpty()) input = "Mr John Smith";
    ...
    // Problem 1.4: Palindrome Permutation (Optimized with Bit Vector)
    public static String runPalindromePermutation(String input) {
        if (input.isEmpty()) input = "taco cat | hello";
    ...
    private static boolean isPalindromePermutationOptimized(String str, StringBuilder output) {
    ...
    public static String runOneAway(String input) {
        if (input.isEmpty()) input = "pale ple | pales pale | pale bale | pale bake";
    ...
    public static String runStringCompression(String input) {
        if (input.isEmpty()) input = "aabcccccaaa";
    ...
    public static String runRotateMatrix(String input) {
        if (input.isEmpty()) input = "3";
    ...
    public static String runZeroMatrix(String input) {
        if (input.isEmpty()) input = "3x3";
    ...
    public static String runStringRotation(String input) {
        if (input.isEmpty()) input = "waterbottle erbottlewat | hello llohe | test fest";
